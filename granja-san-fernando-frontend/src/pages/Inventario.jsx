    ...
    <>
      ...
      <div style={{ marginBottom: '18px' }}>
        <div className="period-tabs" style={{ display: 'inline-flex' }}>
          <button className={pestana === 'concentrado' ? 'active' : ''} onClick={() => setPestana('concentrado')}>
            Concentrado
          </button>
          <button className={pestana === 'medicamentos' ? 'active' : ''} onClick={() => setPestana('medicamentos')}>
            Medicamentos
          </button>
          <button className={pestana === 'huevos' ? 'active' : ''} onClick={() => setPestana('huevos')}>
            Huevos
          </button>
        </div>
      </div>
      ...
      {pestana === 'concentrado' && (
        <>
          <div className="grid-2col">
            <section className="card">
              <div className="head"><h2>Registrar consumo</h2></div>
            ...
            {esAdmin && (
              <section className="card">
                <div className="head"><h2>Registrar compra</h2></div>
      ...
      {pestana === 'medicamentos' && (
        <>
          <div className="grid-2col">
            <section className="card">
              <div className="head"><h2>Registrar salida</h2></div>
      ...
      {pestana === 'huevos' && (
        <>
          <section className="card" style={{ borderLeft: '3px solid var(--gold)' }}>
            <p style={{ fontSize: '13px', color: 'var(--ink-soft)' }}>
              La clasificación diaria de huevos por tamaño se registra en el módulo <b>Producción</b>. Aquí solo puedes
              consultar la existencia actual y el historial.
            </p>
          </section>

          <section className="card">
            <div className="head">
              <h2>Existencia por tamaño</h2>
